...
class Ui_Listes(object):
    _id=0
    DB = db()
    DB.connection("./base/database.db")
    def setupUi(self, Form):
        ...
        self.add.setPopupMode(QtWidgets.QToolButton.DelayedPopup)
        self.add.setToolButtonStyle(QtCore.Qt.ToolButtonFollowStyle)
        ...
        #clicke events 
        #self.MyList.itemSelectionChanged.connect(self.printcurrentindex) 
